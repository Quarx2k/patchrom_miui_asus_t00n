...
.method isEmpty(I)Z
    ...
    .line 104
    .end local v0    # "bEmpty":Z
    .local v1, "bEmpty":I
    :goto_0
    return v1

    .line 97
    .end local v1    # "bEmpty":I
    .restart local v0    # "bEmpty":Z
    :cond_0
    ...
    .local v3, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/bluetooth/gatt/SearchQueue$Entry;>;"
    :cond_1
    ...
    check-cast v2, Lcom/android/bluetooth/gatt/SearchQueue$Entry;

    .line 99
    .local v2, "entry":Lcom/android/bluetooth/gatt/SearchQueue$Entry;
    iget v4, v2, Lcom/android/bluetooth/gatt/SearchQueue$Entry;->connId:I
    ...
    .end local v2    # "entry":Lcom/android/bluetooth/gatt/SearchQueue$Entry;
    :cond_2
    move v1, v0

    .line 104
    .restart local v1    # "bEmpty":I
    goto :goto_0
.end method
...
.method pop(I)Lcom/android/bluetooth/gatt/SearchQueue$Entry;
    .locals 4
    .param p1, "connId"    # I

    .prologue
    .line 108
    new-instance v2, Lcom/android/bluetooth/gatt/SearchQueue$Entry;

    invoke-direct {v2, p0}, Lcom/android/bluetooth/gatt/SearchQueue$Entry;-><init>(Lcom/android/bluetooth/gatt/SearchQueue;)V

    .line 109
    .local v2, "retEntry":Lcom/android/bluetooth/gatt/SearchQueue$Entry;
